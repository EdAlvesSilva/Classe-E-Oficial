...
//--------------------------------------------IMU & SD------------------------------//
  ...
  if (DebugSDSerial) {
//    ss.print(millis());Serial.print(F(" ,"));
//    ss.print(pIMUs1->barometro[0]);Serial.print(F(" ,"));
//    ss.print(pIMUs1->barometro[1]);Serial.print(F(" ,"));
//    ss.print(pIMUs1->barometro[2]);Serial.print(F(" ,"));
//    ss.print(pIMUs1->acelerometro[0]);Serial.print(F(" ,"));
//    ss.print(pIMUs1->acelerometro[1]);Serial.print(F(" ,"));
//    ss.print(pIMUs1->acelerometro[2]);Serial.print(F(" ,"));
//    ss.print(pIMUs1->giroscopio[0]);Serial.print(F(" ,"));
//    ss.print(pIMUs1->giroscopio[1]);Serial.print(F(" ,"));
//    ss.print(pIMUs1->giroscopio[2]);Serial.print(F(" ,"));
//    ss.print(pIMUs1->magnetometro[0]);Serial.print(F(" ,"));
//    ss.print(pIMUs1->magnetometro[1]);Serial.print(F(" ,"));
//    ss.print(pIMUs1->magnetometro[2]);Serial.print(F(" ,"));
